        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-zinc-500 mt-0.5">
              Mục tiêu GP: <strong className="text-zinc-800 font-bold">{job.grossProfitPercent.toFixed(1)}%</strong>
              <span className="mx-1.5 text-zinc-300">•</span>
              Doanh thu: <strong className="text-[#e11d24] font-black font-mono">{formatVND(job.potentialBudget)}</strong>
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white/80 backdrop-blur-2xl rounded-[24px] border border-white/60 shadow-[0_8px_32px_0_rgba(0,0,0,0.06)] overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse text-xs">
            ...
            <tbody>
              <tr>
                <td colSpan={7} className="py-14 px-4 text-center text-zinc-400 bg-white/40">
                  <div className="flex flex-col items-center justify-center gap-2.5">
                    <FileSpreadsheet className="w-9 h-9 text-zinc-300" />
