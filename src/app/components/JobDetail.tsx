...
function SingleJobDetailCard({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-[32px] p-6 sm:p-8 bg-gradient-to-r from-white/85 via-[#fff5f5]/80 to-[#fee2e2]/75 backdrop-blur-2xl border border-white/80 shadow-[0_8px_32px_0_rgba(0,0,0,0.08)] space-y-4">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 relative z-10">
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            <div className="inline-flex items-center gap-2 bg-white/90 backdrop-blur-md text-[#e11d24] px-3.5 py-1.5 rounded-full border border-red-200/80 shadow-2xs shrink-0">
              {job.isLocked ? (
                <span title="Data posted and locked in Arito Accounting">
                  <Lock className="w-3.5 h-3.5 text-[#e11d24]" />
                </span>
              ) : (
          ...
          <div className="flex items-center gap-2.5 shrink-0">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2 text-xs font-black text-white bg-[#e11d24] hover:bg-[#b91c1c] rounded-full transition-all active:scale-95 shadow-lg shadow-red-600/25 cursor-pointer disabled:opacity-60"
            >
              <RefreshCw className={`w-3.5 h-3.5 ${isSyncingArito ? 'animate-spin text-red-200' : 'text-white'}`} />
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 text-xs font-bold text-zinc-800 bg-white/80 hover:bg-white border border-white/60 rounded-full transition-all active:scale-95 shadow-2xs backdrop-blur-md cursor-pointer"
            >
        ...
        <div className="space-y-1 relative z-10">
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-black text-zinc-950 tracking-tight">
            {job.jobName}
          </h1>
          {job.description && (
            <p className="text-xs sm:text-sm text-zinc-600 max-w-3xl leading-relaxed font-medium">
              {job.description}
            </p>
          )}
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3.5 text-xs">
        {/* 3. Client */}
        <div className="bg-white/80 backdrop-blur-2xl p-4 rounded-[24px] border border-white/60 shadow-[0_8px_32px_0_rgba(0,0,0,0.06)] flex flex-col justify-between hover:shadow-[0_12px_40px_rgba(225,29,36,0.08)] transition-all">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="min-w-0 flex-1">
              <span className="text-xs font-black text-zinc-900 block truncate" title={job.client}>
                {job.client}
              </span>
              <span className="text-[11px] font-mono text-[#e11d24] font-bold block truncate">
        ...
        <div className="bg-white/80 backdrop-blur-2xl p-4 rounded-[24px] border border-white/60 shadow-[0_8px_32px_0_rgba(0,0,0,0.06)] flex flex-col justify-between hover:shadow-[0_12px_40px_rgba(225,29,36,0.08)] transition-all">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-bold text-zinc-800 truncate" title={job.contractClient || job.client}>
              {job.contractClient || job.client}
            </span>
          </div>
          <span className="text-[10px] text-zinc-400 block truncate mt-1">Arito Legal Entity</span>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-2xl p-4 rounded-[24px] border border-white/60 shadow-[0_8px_32px_0_rgba(0,0,0,0.06)] flex flex-col justify-between hover:shadow-[0_12px_40px_rgba(225,29,36,0.08)] transition-all">
          ...
          <div className="flex items-center gap-2">
            <span className="px-3 py-1 bg-red-500/10 text-[#e11d24] border border-red-200/80 font-black rounded-full text-xs">
              {job.clientType || 'Existing Client'}
            </span>
          </div>
          <span className="text-[10px] text-zinc-400 block truncate mt-1">Tier 1 Strategic Partner</span>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-2xl p-4 rounded-[24px] border border-white/60 shadow-[0_8px_32px_0_rgba(0,0,0,0.06)] flex flex-col justify-between hover:shadow-[0_12px_40px_rgba(225,29,36,0.08)] transition-all">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="min-w-0 flex-1">
              <span className="text-xs font-black text-zinc-900 block truncate" title={job.brand}>
                {job.brand}
              </span>
        ...
        <div className="bg-gradient-to-br from-white/85 to-[#fee2e2]/70 backdrop-blur-2xl p-4 rounded-[24px] border border-white/70 shadow-[0_8px_32px_0_rgba(0,0,0,0.06)] col-span-2 sm:col-span-1 flex flex-col justify-between hover:shadow-[0_12px_40px_rgba(225,29,36,0.08)] transition-all">
          <span className="text-[10px] text-red-900 font-extrabold uppercase tracking-wider block mb-1">
            Potential Budget
          </span>
          <div>
            <span className="text-sm sm:text-base font-black text-zinc-950 block truncate">
              {formatVND(job.potentialBudget)}
            </span>
            <span className="text-[11px] font-extrabold text-[#e11d24] block truncate mt-0.5">
      ...
      <div className="bg-white/80 backdrop-blur-2xl p-2 rounded-[28px] border border-white/60 shadow-[0_8px_32px_0_rgba(0,0,0,0.06)] space-y-1.5">
        {/* Row 1: 4 Core Tabs */}
            ...
            return (
              <button
                ...
                className={`flex-1 min-w-0 py-2.5 px-3 sm:px-4 text-xs sm:text-sm font-semibold rounded-full transition-all duration-200 flex items-center justify-center gap-2 select-none cursor-pointer ${
                  isActive
                    ? 'bg-gradient-to-r from-[#e11d24] to-[#b91c1c] text-white shadow-md shadow-red-600/30 font-bold scale-[1.01]'
                    : 'text-zinc-600 hover:text-zinc-950 hover:bg-white/60'
                }`}
              >
                <Icon className={`w-4 h-4 shrink-0 transition-transform duration-200 ${isActive ? 'scale-110 text-white' : 'text-zinc-400'}`} />
      ...
      {activeTab === 'general' && (
        <div key="tab-general" className={`space-y-6 ${tabDirection === 'right' ? 'animate-tab-glide-right' : 'animate-tab-glide-left'}`}>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
            ...
            <div className="bg-white/80 backdrop-blur-2xl p-6 sm:p-7 rounded-[28px] border border-white/60 shadow-[0_8px_32px_0_rgba(0,0,0,0.06)] space-y-4">
              <span className="text-[10px] font-extrabold text-[#e11d24] bg-red-500/10 px-3 py-1 rounded-full uppercase tracking-wider inline-block border border-red-200/60">
                Execution Timeline
              </span>
              <h2 className="text-sm font-black text-zinc-900 flex items-center gap-2">
                <Calendar className="w-4 h-4 text-[#e11d24]" />
                <span>Project Milestones (Timeline)</span>
              </h2>

              <div className="space-y-3 text-xs">
                <div className="flex items-center justify-between p-3.5 bg-white/60 backdrop-blur-md rounded-[18px] border border-black/[0.03]">
                  <span className="text-zinc-500 font-medium">Start Date:</span>
                  <span className="font-bold text-zinc-800 font-mono">{job.startDate}</span>
                </div>
                <div className="flex items-center justify-between p-3.5 bg-gradient-to-r from-white/80 to-[#fee2e2]/60 backdrop-blur-md rounded-[18px] border border-red-200/50">
                  <span className="text-red-900 font-semibold">Confirmed Kick-off:</span>
                  <span className="font-black text-[#e11d24] font-mono">{job.kickoffDate}</span>
                </div>
                <div className="flex items-center justify-between p-3.5 bg-white/60 backdrop-blur-md rounded-[18px] border border-black/[0.03]">
                  <span className="text-zinc-500 font-medium">End Date:</span>
                  <span className="font-bold text-zinc-800 font-mono">{job.endDate}</span>
                </div>
              </div>
            </div>
            ...
            {/* 2. Venue & Scope */}
            <div className="bg-white/80 backdrop-blur-2xl p-6 sm:p-7 rounded-[28px] border border-white/60 shadow-[0_8px_32px_0_rgba(0,0,0,0.06)] space-y-4">
              <span className="text-[10px] font-extrabold text-zinc-700 bg-zinc-100/80 px-3 py-1 rounded-full uppercase tracking-wider inline-block border border-zinc-200/60">
                Scope of Work
              </span>
              <h2 className="text-sm font-black text-zinc-900 flex items-center gap-2">
              ...
              <div className="space-y-3 text-xs">
                <div className="p-3.5 bg-white/60 backdrop-blur-md rounded-[18px] border border-black/[0.03]">
                  <span className="text-zinc-400 font-bold text-[10px] uppercase tracking-wider block mb-1">
                    Deployment Venue
                  </span>
            ...
            <div className="bg-white/80 backdrop-blur-2xl p-6 sm:p-7 rounded-[28px] border border-white/60 shadow-[0_8px_32px_0_rgba(0,0,0,0.06)] space-y-4">
              ...
              <div className="space-y-3 text-xs">
                ...
                <div className="p-4 bg-gradient-to-br from-white/90 to-[#fee2e2]/60 backdrop-blur-md rounded-[20px] border border-red-100/70 space-y-1.5">
                  <div className="flex justify-between items-center">
                    <span className="text-zinc-600 font-medium">Total Allocated Revenue:</span>
                    <span className="font-black text-zinc-950 text-sm">
                      {formatVND(job.allocatedBilling > 0 ? job.allocatedBilling : job.potentialBudget)}
                    </span>
                  </div>
                  <div className="flex justify-between text-zinc-400 text-[11px] pt-1.5 border-t border-red-200/50 font-medium">
                    <span>Execution Period:</span>
                    <span className="text-[#e11d24] font-bold font-mono">{job.startDate} → {job.endDate}</span>
                  </div>
                </div>

                {/* Interactive Accordion for Monthly Revenue Breakdown */}
                <div className="rounded-[20px] border border-black/[0.04] overflow-hidden bg-white/60 backdrop-blur-md">
                  <button
                    type="button"
                    onClick={() => setIsRevenueBreakdownOpen(!isRevenueBreakdownOpen)}
                    className="w-full px-4 py-3 flex items-center justify-between text-left hover:bg-white/80 transition-all cursor-pointer"
                  >
                    <div className="flex items-center gap-2">
                      <Calendar className="w-3.5 h-3.5 text-[#e11d24] shrink-0" />
                      <span className="font-bold text-zinc-800 text-xs">
                        Allocation Breakdown
                      </span>
                    </div>
                    <div className="flex items-center gap-1 text-[11px] text-[#e11d24] font-bold">
                  ...
                  >
                    <div className="min-h-0 overflow-hidden">
                      <div className="px-4 pb-4 pt-1 border-t border-zinc-200/60 space-y-2 bg-white/80 backdrop-blur-md">
                        <div className="divide-y divide-zinc-100">
                          {monthlyRevenueList.map((m) => (
                            <div key={m.monthIndex} className="py-2.5 first:pt-1 last:pb-0 space-y-1.5">
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  <span className="font-bold text-zinc-900 text-xs">{m.monthLabel}</span>
                                  {m.period && (
                                    <span className="px-2 py-0.5 rounded-full text-[10px] font-semibold bg-red-50 text-[#e11d24] border border-red-100">
                                      {m.period}
                                    </span>
                                  )}
                                </div>
                              ...
                              <div className="w-full bg-zinc-200/70 rounded-full h-1.5 overflow-hidden">
                                <div
                                  className="bg-gradient-to-r from-[#f87171] to-[#e11d24] h-1.5 rounded-full transition-all duration-300"
                                  style={{ width: `${Math.min(m.percentage, 100)}%` }}
                                />
                              </div>

                              {m.note && (
                                <p className="text-[10px] text-zinc-400 truncate mt-0.5 font-medium" title={m.note}>
                                  {m.note}
                                </p>
                              )}
                            </div>
                        ...
                        {/* Summary total */}
                        <div className="pt-2.5 border-t border-dashed border-zinc-200 flex items-center justify-between text-[11px] font-bold">
          ...
          <div className="bg-white/80 backdrop-blur-2xl p-6 sm:p-7 rounded-[28px] border border-white/60 shadow-[0_8px_32px_0_rgba(0,0,0,0.06)] space-y-5">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                <span className="text-[10px] font-extrabold text-[#e11d24] bg-red-500/10 px-3 py-1 rounded-full uppercase tracking-wider inline-block mb-1 border border-red-200/60">
                  Execution Status
                </span>
                <h2 className="text-base font-black text-zinc-900">Project Progress Logs</h2>
              </div>

              <button
                type="button"
                onClick={() => setIsAddProgressOpen(true)}
                className="inline-flex items-center gap-2 px-4 py-2 text-xs font-bold text-white bg-[#e11d24] hover:bg-[#b91c1c] rounded-full shadow-md shadow-red-600/25 active:scale-95 transition-all cursor-pointer"
              >
            ...
            <div className="overflow-x-auto rounded-[22px] border border-black/[0.04] bg-white/70 backdrop-blur-md custom-scrollbar">
              <table className="w-full text-left text-xs border-collapse">
                <thead>
                  <tr className="bg-white/60 text-zinc-500 uppercase font-bold text-[11px] border-b border-zinc-100">
                ...
                <tbody className="divide-y divide-zinc-100">
                  {progressLogs.map((log, index) => (
                    <tr key={log.id} className="hover:bg-white/90 transition-colors">
                      <td className="py-3.5 px-4 text-center text-zinc-400 font-medium">{index + 1}</td>
                      <td className="py-3.5 px-4 font-bold text-zinc-700 font-mono">{log.date}</td>
                      <td className="py-3.5 px-4 font-semibold text-zinc-900">{log.status}</td>
                      <td className="py-3.5 px-4 text-[#e11d24] font-semibold">{log.nextStep}</td>
                      <td className="py-3.5 px-4 text-zinc-600 font-medium">{log.byStaff}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <div key="tab-client" className={`space-y-6 ${tabDirection === 'right' ? 'animate-tab-glide-right' : 'animate-tab-glide-left'}`}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="bg-white/80 backdrop-blur-2xl p-6 sm:p-7 rounded-[28px] border border-white/60 shadow-[0_8px_32px_0_rgba(0,0,0,0.06)] space-y-5">
              ...
              <h2 className="text-base font-black text-zinc-900">General Client Profile</h2>

              <div className="space-y-3.5 text-xs sm:text-sm">
                <div className="p-3.5 bg-white/60 backdrop-blur-md rounded-[18px] border border-black/[0.03] grid grid-cols-3 gap-2 items-center">
                  <span className="text-zinc-400 text-xs font-semibold">Client Name:</span>
                  <div className="col-span-2 flex items-center gap-2.5">
                    <ClientLogo client={job.client} className="w-7 h-7 rounded-[10px]" />
                    <span className="font-black text-zinc-900">{job.client}</span>
                  </div>
                </div>
                <div className="p-3.5 bg-white/60 backdrop-blur-md rounded-[18px] border border-black/[0.03] grid grid-cols-3 gap-2 items-center">
                  <span className="text-zinc-400 text-xs font-semibold">Contracted Entity:</span>
                  <span className="col-span-2 font-bold text-zinc-800">{job.contractClient}</span>
                </div>
                <div className="p-3.5 bg-white/60 backdrop-blur-md rounded-[18px] border border-black/[0.03] grid grid-cols-3 gap-2 items-center">
                  <span className="text-zinc-400 text-xs font-semibold">Brand:</span>
                  <div className="col-span-2 flex items-center gap-2.5">
                    <BrandLogo brand={job.brand} className="w-7 h-7 rounded-[10px]" />
                    <span className="font-extrabold text-[#e11d24]">{job.brand}</span>
                  </div>
                </div>
                <div className="p-3.5 bg-white/60 backdrop-blur-md rounded-[18px] border border-black/[0.03] grid grid-cols-3 gap-2">
                  <span className="text-zinc-400 text-xs font-semibold">Contact Person:</span>
                  <div className="col-span-2 space-y-1">
                    <p className="font-bold text-zinc-900">{job.contactPerson?.name || 'Mr. Nhân Mai (Procurement Manager)'}</p>
                    <p className="text-xs text-zinc-500 font-mono">Phone: {job.contactPerson?.phone || '0903 123 456'}</p>
                    <p className="text-xs text-zinc-500 font-mono">Email: {job.contactPerson?.email || 'nhan.mai@unilever.com'}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-2xl p-6 sm:p-7 rounded-[28px] border border-white/60 shadow-[0_8px_32px_0_rgba(0,0,0,0.06)] space-y-5">
              ...
              <h2 className="text-base font-black text-zinc-900">Legal & Tax Identification</h2>

              <div className="space-y-3.5 text-xs sm:text-sm">
                <div className="p-3.5 bg-white/60 backdrop-blur-md rounded-[18px] border border-black/[0.03] grid grid-cols-3 gap-2 items-center">
                  <span className="text-zinc-400 text-xs font-semibold">Client Code:</span>
                  <span className="col-span-2 font-mono font-black text-zinc-900">{job.clientCode}</span>
                </div>
                <div className="p-3.5 bg-white/60 backdrop-blur-md rounded-[18px] border border-black/[0.03] grid grid-cols-3 gap-2 items-center">
                  <span className="text-zinc-400 text-xs font-semibold">Tax Identification:</span>
                  <span className="col-span-2 font-mono font-bold text-zinc-800">0303123849-001</span>
                </div>
                <div className="p-3.5 bg-white/60 backdrop-blur-md rounded-[18px] border border-black/[0.03] grid grid-cols-3 gap-2">
                  <span className="text-zinc-400 text-xs font-semibold">Registered Address:</span>
                  <span className="col-span-2 text-zinc-700 font-medium leading-relaxed">Tòa nhà Unilever, 156 Nguyễn Lương Bằng, P. Tân Phú, Quận 7, TP.HCM</span>
                </div>
                <div className="p-3.5 bg-white/60 backdrop-blur-md rounded-[18px] border border-black/[0.03] grid grid-cols-3 gap-2 items-center">
                  <span className="text-zinc-400 text-xs font-semibold">Framework Contract:</span>
                  <span className="col-span-2 text-[#e11d24] font-mono font-bold">{job.contractCode || 'MSA-2025/ULV-SQC-MASTER'}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-2xl p-6 sm:p-7 rounded-[28px] border border-white/60 shadow-[0_8px_32px_0_rgba(0,0,0,0.06)] space-y-5">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div>
                ...
                <h2 className="text-base font-black text-zinc-900">Assigned Team Members & SQC Bonus Scheme</h2>
              </div>

              {/* Exact styling of "+ Add member" Square Red pill button */}
              <button
                type="button"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-5 bg-gradient-to-br from-white/90 to-[#fee2e2]/60 backdrop-blur-md rounded-[24px] border border-red-100/80">
                <span className="text-xs text-zinc-500 font-semibold block">Total Allocated Bonus</span>
                <span className="text-2xl font-black text-zinc-950 mt-1 block">
                  {members.reduce((sum, m) => sum + m.bonusPercent, 0)}%
                </span>
                <span className="text-[11px] text-[#e11d24] mt-1 block font-bold">
                  Equivalent to {formatVND(members.reduce((sum, m) => sum + m.assignedBudget, 0))}
                </span>
              </div>
              <div className="p-5 bg-white/60 backdrop-blur-md rounded-[24px] border border-black/[0.03]">
                <span className="text-xs text-zinc-500 font-semibold block">Average KPI Target</span>
              ...
              <div className="p-5 bg-white/80 backdrop-blur-md rounded-[24px] border border-black/[0.03] shadow-2xs">
                <span className="text-xs text-zinc-500 font-semibold block">CSAT Target Score</span>
                <span className="text-2xl font-black text-zinc-900 mt-1 block">
                  {(members.reduce((sum, m) => sum + m.csatScore, 0) / (members.length || 1)).toFixed(1)} / 5.0
                </span>
                <span className="text-[11px] text-zinc-500 mt-1 block font-medium">Square Communications Quality Standard</span>
              </div>
            </div>

            <div className="overflow-x-auto rounded-[22px] border border-black/[0.04] bg-white/70 backdrop-blur-md custom-scrollbar">
              <table className="w-full text-left text-xs">
                <thead className="bg-white/60 text-zinc-500 font-bold uppercase text-[11px] border-b border-zinc-100">
                  <tr>
                ...
                <tbody className="divide-y divide-zinc-100">
                  {members.map((mem) => (
                    <tr key={mem.id} className="hover:bg-white/90 transition-colors">
                      <td className="py-3.5 px-4">
                        <div className="flex items-center gap-2.5">
                          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#fee2e2] to-[#fecaca] text-[#b91c1c] font-black flex items-center justify-center text-xs shadow-2xs">
                            {mem.avatar}
                          </div>
                          <div>
                            <p className="font-black text-zinc-900">{mem.name}</p>
                            <p className="text-[10px] text-zinc-400 font-mono">{mem.email}</p>
                          </div>
                        </div>
                      </td>
                      <td className="py-3.5 px-4">
                        <p className="font-bold text-zinc-800">{mem.role}</p>
                        <p className="text-[10px] text-zinc-400 font-medium">{mem.department}</p>
                      </td>
                      <td className="py-3.5 px-4 text-center">
                        <span className="px-2.5 py-1 rounded-full bg-red-500/10 text-[#e11d24] font-black text-[11px] border border-red-200/50">
                          {mem.bonusPercent}%
                        </span>
                      </td>
                      ...
                      <td className="py-3.5 px-4 text-center font-black text-[#e11d24]">
                        ⭐ {mem.csatScore}
                      </td>
          ...
          <div className="bg-white/80 backdrop-blur-2xl p-6 sm:p-7 rounded-[28px] border border-white/60 shadow-[0_8px_32px_0_rgba(0,0,0,0.06)] space-y-5">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div>
                ...
                <h2 className="text-base font-black text-zinc-900">Billing Milestones & Direct Project Costs</h2>
              </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-3.5">
              <div className="p-4 bg-white/60 backdrop-blur-md rounded-[22px] border border-black/[0.03]">
                <span className="text-[10px] text-zinc-400 font-bold uppercase tracking-wider block">Total Planned</span>
                <span className="text-base font-black text-zinc-900 mt-1 block">{formatVND(totalPlannedPayment)}</span>
                <span className="text-[10px] text-zinc-500 font-bold block mt-0.5">{totalPaymentPercent}% of contract</span>
              </div>
              <div className="p-4 bg-gradient-to-br from-white/90 to-[#fee2e2]/60 backdrop-blur-md rounded-[22px] border border-red-100/80">
                <span className="text-[10px] text-red-900 font-bold uppercase tracking-wider block">Total Invoiced</span>
                <span className="text-base font-black text-zinc-950 mt-1 block">{formatVND(totalInvoiced)}</span>
                <span className="text-[10px] text-[#e11d24] font-bold block mt-0.5">VAT Invoice Issued</span>
              </div>
              <div className="p-4 bg-white/60 backdrop-blur-md rounded-[22px] border border-black/[0.03]">
                <span className="text-[10px] text-zinc-400 font-bold uppercase tracking-wider block">Actual Received</span>
              ...
              <div className="p-4 bg-white/60 backdrop-blur-md rounded-[22px] border border-black/[0.03]">
                <span className="text-[10px] text-zinc-400 font-bold uppercase tracking-wider block">Direct Cost Spent</span>
                <span className="text-base font-black text-zinc-900 mt-1 block">{formatVND(totalCostSpent)}</span>
                <span className="text-[10px] text-zinc-500 font-bold block mt-0.5">Remaining: {formatVND(totalCostRemaining)}</span>
              </div>
              <div className="p-4 bg-white/80 backdrop-blur-md rounded-[22px] border border-black/[0.03] shadow-2xs col-span-2 sm:col-span-1">
              ...
              <table className="w-full text-left text-xs">
                ...
                <tbody className="divide-y divide-zinc-100">
                  {paymentTerms.map((term) => (
                    <tr key={term.id} className="hover:bg-white/90 transition-colors">
                      <td className="py-3.5 px-4">
                        <div className="space-y-0.5">
                          <p className="font-black text-zinc-900">{term.termName}</p>
                          <div className="flex items-center gap-2 text-[10px] text-zinc-400 font-mono">
                            {term.poNumber && <span className="bg-white/80 px-2 py-0.5 rounded-md text-zinc-600 font-semibold border border-black/[0.03]">PO: {term.poNumber}</span>}
                            {term.acceptanceDoc && <span>BB: {term.acceptanceDoc}</span>}
                          </div>
                        </div>
                      </td>
                      <td className="py-3.5 px-4 text-center">
                        <span className="font-black px-2.5 py-1 bg-red-500/10 text-[#e11d24] rounded-full text-[11px] border border-red-200/50">
                          {term.percentage}%
                        </span>
                      </td>
                      <td className="py-3.5 px-4 text-right font-black text-zinc-900">
                      ...
                      <td className="py-3.5 px-4 text-center text-zinc-600 font-mono text-[11px]">
                        {term.plannedDate}
                      </td>
                      <td className="py-3.5 px-4 text-center text-zinc-600 font-mono text-[11px]">
                        {term.dueDate}
                      ...
                      <td className="py-3.5 px-4 text-right">
                        <p className="font-black text-[#e11d24]">{formatVND(term.invoicedAmount)}</p>
                      ...
                      <td className="py-3.5 px-4 text-right text-[11px]">
                        <span className="font-bold text-zinc-900">{formatVND(term.actualCostSpent)}</span>
                        <span className="text-zinc-400 font-semibold block">{formatVND(term.actualCostRemaining)}</span>
                      </td>
                      <td className="py-3.5 px-4 text-center">
      ...
      {isAddMemberOpen && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white/95 backdrop-blur-2xl rounded-[30px] max-w-md w-full p-6 sm:p-7 shadow-2xl border border-white/80 space-y-4 animate-scaleUp">
            <h3 className="text-base font-black text-zinc-900">Add Project Member</h3>
            
            <form onSubmit={handleAddMember} className="space-y-4 text-xs">
              <div>
                <label className="block font-bold text-zinc-700 mb-1">Staff Member</label>
                <CustomSelect
              ...
              <div>
                <label className="block font-bold text-zinc-700 mb-1">Role in Project</label>
                <input 
                  type="text" 
                  value={newMemberRole} 
                  onChange={(e) => setNewMemberRole(e.target.value)}
                  placeholder="e.g. Senior Project Manager"
                  className="w-full p-3 bg-zinc-100/80 border border-black/[0.06] rounded-[16px] text-xs font-semibold focus:bg-white focus:outline-hidden focus:ring-2 focus:ring-red-400"
                />
              </div>

              <div>
                <label className="block font-bold text-zinc-700 mb-1">Department</label>
                <CustomSelect
              ...
              <div>
                <div className="flex justify-between items-center mb-1">
                  <label className="font-bold text-zinc-700">Bonus Percentage (%)</label>
                  <span className="font-black text-[#e11d24]">{newMemberBonus}%</span>
                </div>
                <input 
                  type="range" 
                  min="1" 
                  ...
                  className="w-full accent-[#e11d24]"
                />
              ...
              <div className="flex items-center justify-end gap-2 pt-3 border-t border-zinc-100">
                <button
                  ...
                  className="px-5 py-2.5 text-zinc-600 hover:bg-zinc-100 rounded-full font-bold transition-all cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="px-6 py-2.5 bg-[#e11d24] text-white rounded-full font-bold hover:bg-[#b91c1c] shadow-md shadow-red-600/25 active:scale-95 transition-all cursor-pointer"
                >
                  Assign to Job
                </button>
              </div>
      ...
      {isAddPaymentOpen && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white/95 backdrop-blur-2xl rounded-[30px] max-w-lg w-full p-6 sm:p-7 shadow-2xl border border-white/80 space-y-4 animate-scaleUp">
            <h3 className="text-base font-black text-zinc-900">Add Payment Milestone</h3>
            
            <form onSubmit={handleAddPayment} className="space-y-3.5 text-xs">
              <div>
                <label className="block font-bold text-zinc-700 mb-1">Milestone Name / Term</label>
                <input 
                  type="text" 
                  value={newTermName} 
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block font-bold text-zinc-700 mb-1">Percentage (%)</label>
                  <input 
                    type="number" 
                    min="1" 
                    max="100" 
                    ...
                    required
                    className="w-full p-3 bg-zinc-100/80 border border-black/[0.06] rounded-[16px] text-xs font-black focus:bg-white focus:outline-hidden focus:ring-2 focus:ring-red-400"
                  />
                ...
                <div>
                  <label className="block font-bold text-zinc-700 mb-1">Planned Date</label>
                  <CustomDatePicker 
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block font-bold text-zinc-700 mb-1">Due Date</label>
                  <CustomDatePicker 
                ...
                <div>
                  <label className="block font-bold text-zinc-700 mb-1">Customer PO Code</label>
                  <input 
                    type="text" 
                    value={newTermPo} 
              ...
              <div>
                <label className="block font-bold text-zinc-700 mb-1">Initial Cost Spent</label>
                <input 
                  type="number" 
              ...
              <div>
                <label className="block font-bold text-zinc-700 mb-1">Acceptance Document</label>
                <input 
                  type="text" 
      ...
      {isAddProgressOpen && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white/95 backdrop-blur-2xl rounded-[30px] max-w-md w-full p-6 sm:p-7 shadow-2xl border border-white/80 space-y-4 animate-scaleUp">
            <h3 className="text-base font-black text-zinc-900">Update Progress Log</h3>
            ...
            <form onSubmit={handleAddProgress} className="space-y-4 text-xs">
              <div>
                ...
                <textarea 
                  ...
                  required
                  className="w-full p-3 bg-zinc-100/80 border border-black/[0.06] rounded-[16px] text-sm font-medium focus:bg-white focus:outline-hidden focus:ring-2 focus:ring-red-400"
                />
              </div>

              <div>
                <label className="block font-bold text-zinc-700 mb-1">Next Action / Step</label>
                <input 
                  type="text" 
...
export default function JobDetail({ 
  ...
  return (
    <div className="space-y-10 pb-24 relative">
      ...
      {isLoadingMore && (
        <div className="rounded-[28px] border border-white/60 bg-white/80 backdrop-blur-2xl p-6 sm:p-7 shadow-[0_8px_32px_0_rgba(0,0,0,0.06)] space-y-5 animate-pulse">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="h-8 w-28 bg-red-500/10 rounded-full border border-red-200/50" />
              <div className="h-6 w-48 sm:w-64 bg-zinc-200 rounded-xl" />
              <div className="h-6 w-20 bg-zinc-100 rounded-full" />
            </div>
            <div className="flex items-center gap-2">
              <div className="h-8 w-24 bg-[#e11d24]/20 rounded-full" />
              <div className="h-8 w-28 bg-zinc-100 rounded-full" />
            </div>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-3.5 pt-1">
            {[1, 2, 3, 4, 5].map((k) => (
              <div key={k} className="h-16 bg-white/60 border border-black/[0.02] rounded-[20px]" />
            ))}
          </div>
        </div>
      )}
      ...
      {hasMore && (
        <div ref={sentinelRef} className="py-6 flex flex-col items-center justify-center">
          {isLoadingMore ? (
            <div className="flex items-center gap-3 px-5 py-3 rounded-full bg-white/90 backdrop-blur-md border border-white/60 shadow-[0_8px_32px_0_rgba(0,0,0,0.06)] text-zinc-900 text-xs font-bold animate-pulse">
              <Loader2 className="w-4 h-4 animate-spin text-[#e11d24]" />
              <span>Loading next project ({orderedJobs[visibleCount]?.jobCode})...</span>
            </div>
          ) : (
            <div className="h-6 w-full flex items-center justify-center">
              <div className="w-8 h-1 bg-zinc-400 rounded-full animate-pulse" />
            </div>
          )}
        </div>
      )}
